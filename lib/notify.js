    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#fff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb">
        ...
        <tr><td style="padding:14px 24px 0">
          ...
          <div style="display:grid;grid-template-columns:${photos.length === 1 ? "1fr" : "1fr 1fr"};gap:8px">
            ${photos.map(u => `<img src="${esc(u)}" alt="Roof photo" style="width:100%;height:180px;object-fit:cover;border-radius:8px;display:block">`).join("")}
          </div>
        </td></tr>` : ""}
